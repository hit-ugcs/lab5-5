class Student < ActiveRecord::Base
  ...
  def calc_total
    self.lab = (self.lab1 + self.lab2 + self.lab3 + self.lab4 + self.lab5 + self.lab6 + self.lab7) / 7
    self.classdiscussion = (self.classdiscussion1 + self.classdiscussion2 + self.classdiscussion3 + self.classdiscussion4 + self.classdiscussion5 + self.classdiscussion6 + self.classdiscussion7 + self.classdiscussion8 + self.classdiscussion9 + self.classdiscussion10 + self.classdiscussion11) / 11
    self.project = (self.project1 + self.project2 + self.project3) / 3
    self.total = self.final * 0.4 + self.lab * 0.1 + self.classdiscussion * 0.1 + self.project * 0.4
  end
end
